  ...
  connectedCallback() {
    this.root.innerHTML = `
        ...
        #drawer
        {
            ...
            padding: 0 15px; margin-bottom: 3px; width: 24px; vertical-align: middle;
            }
            .item{
            text-decoration: none; -webkit-tap-highlight-color: rgba(0,0,0,.1); display: flex; align-items: center; color: rgba(0,0,0,.54); height: 48px; line-height: 20px; width: 100%; vertical-align: middle; outline: 0;
            }
            </style>
