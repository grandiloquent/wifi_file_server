...
(function(global, factory) {
 ...
 // \r
  ...
  default_rules.code_block = function(tokens, idx, options, env, slf) {
    var token = tokens[idx];
    return `<div class="code-header"><span class="language"></span><button type="button" class="action"><span class="icon" aria-hidden="true"><span class="edit-copy"></span></span><span>复制</span><div class="successful-copy-alert" aria-hidden="true"><span class="check-mark"></span></div></button></div><pre` + slf.renderAttrs(token) + "><code>" + escapeHtml(tokens[idx].content) + "</code></pre>\n";
  };
  default_rules.fence = function(tokens, idx, options, env, slf) {
    ...
    // now we prefer to keep things local.
      ...
      return `<div class="code-header"><span class="language"></span><button type="button" class="action"><span class="icon" aria-hidden="true"><span class="edit-copy"></span></span><span>复制</span><div class="successful-copy-alert" aria-hidden="true"><span class="check-mark"></span></div></button></div><pre><code` + slf.renderAttrs(tmpToken) + ">" + highlighted + "</code></pre>\n";
    }
    return `<div class="code-header"><span class="language"></span><button type="button" class="action"><span class="icon" aria-hidden="true"><span class="edit-copy"></span></span><span>复制</span><div class="successful-copy-alert" aria-hidden="true"><span class="check-mark"></span></div></button></div><pre><code` + slf.renderAttrs(token) + ">" + highlighted + "</code></pre>\n";
  };
